        ...
        <div class="container-fluid">
            ...
            <div class="row heading-bg">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Add Unit of Measure</h5>
                    @if(Session::has('save'))
                        {{ Session::get('save') }}
                    @endif
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><span>Unit of Measure</span></li>
                    </ol>
                </div>
                <!-- /Breadcrumb -->
            </div>
                    ...
                    <div class="panel panel-default card-view">
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div class="form-wrap">
                                    <form action="{{route('admin.unitmeasure.store')}}" method="post">
                                        {{ csrf_field() }}

                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <label class="control-label mb-10">Unit Name</label>
                                                <input type="text" id="unit_of_measure" class="form-control" placeholder="Add unit" name="name" required value="{{old('name')}}">
                                                @if($errors->has('name'))
